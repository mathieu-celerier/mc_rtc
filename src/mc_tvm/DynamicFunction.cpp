...
DynamicFunction::DynamicFunction(const mc_rbdyn::Robot & robot, bool addExternalTorques)
: tvm::function::abstract::LinearFunction(robot.mb().nrDof()), robot_(robot), useExternalForces_(addExternalTorques)
{
