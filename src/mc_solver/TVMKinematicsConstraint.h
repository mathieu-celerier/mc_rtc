...
struct TVMKinematicsConstraint
{
  ...
  std::array<double, 4> damperSecond_; // Second order dynamics dampers
  ...
  TVMKinematicsConstraint(const mc_rbdyn::Robot & robot, const std::array<double, 4> & damperSecond, double vp);
